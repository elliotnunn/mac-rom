...
"{LibDir}ToolboxEventMgr.lib"			Ä	{ToolboxEventMgrObjs}
	Lib {StdLibOpts} -o "{Targ}" {ToolboxEventMgrObjs}


"{ObjDir}ToolboxEventMgrPatches.a.o"	Ä	"{ToolboxEventDir}ToolboxEventMgrPatches.a"
	Asm {StdAOpts} -o "{Targ}" "{ToolboxEventDir}ToolboxEventMgrPatches.a"


"{ObjDir}ToolboxEventMgr.a.o"			Ä	"{ObjDir}StandardEqu.d"							¶
											"{AIncludes}SCSI.a"						¶
