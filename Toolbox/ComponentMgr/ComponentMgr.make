...
"{ObjDir}ThingManager.c.o" 			Ä  	"{ComponentMgrDir}ThingManager.c" 				¶
										"{ComponentMgrDir}ComponentMgr.make"			¶
										"{CIncludes}Types.h"							¶
										"{CIncludes}Memory.h"							¶
										"{CIncludes}OSUtils.h"							¶
...
"{ObjDir}ThingSearch.c.o" 			Ä  	"{ComponentMgrDir}ThingSearch.c" 				¶
										"{ComponentMgrDir}ComponentMgr.make"			¶
										"{ComponentMgrDir}ComponentManagerSelectors.h"	¶
										"{ComponentMgrDir}Components.h"					¶
										"{CIncludes}Resources.h"						¶
...
"{ObjDir}ThingFiles.c.o" 			Ä  	"{ComponentMgrDir}ThingFiles.c" 				¶
										"{ComponentMgrDir}ComponentMgr.make"			¶
										"{CIncludes}Files.h"							¶
										"{CIncludes}Resources.h"						¶
										"{CIncludes}Memory.h"							¶
