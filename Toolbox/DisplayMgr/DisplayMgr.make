...
#	   <SM7>	08-17-93	jmp		OopsÉ in SuperMario we have ÒObjDirÓs not ÒObjectsÓ.
...
"{ObjDir}DisplayMgr.a.o" Ä		"{ObjDir}StandardEqu.d"					¶
...
"{ObjDir}DisplayMgrUtils.c.o" Ä	"{CIncludes}AppleEvents.h"				¶
...
"{ObjDir}DisplayMgrCompatibility.c.o" Ä ¶
								"{CIncludes}GestaltEqu.h"				¶
...
"{ObjDir}DisplayMgrOverlap.c.o" Ä ¶
								"{CIncludes}Types.h"					¶
								"{CIncludes}GestaltEqu.h"				¶
								"{IntCIncludes}DisplaysPriv.h"			¶
								"{IntCIncludes}ExpandMemPriv.h"			¶
...
"{ObjDir}DisplayMgr.c.o" Ä		"{CIncludes}AppleEvents.h"				¶
								"{CIncludes}GestaltEqu.h"				¶
								"{CIncludes}Menus.h"					¶
								"{CIncludes}Processes.h"				¶
								"{CIncludes}QDOffscreen.h"				¶
