...
"{ObjDir}DialogMgrExtensions.a.o"		Ä	"{ObjDir}StandardEqu.d"						¶
											"{AIncludes}Processes.a"					¶
											"{DialogDir}DialogMgrExtensions.a"
	Asm {StdAOpts} -o "{Targ}" "{DialogDir}DialogMgrExtensions.a"


"{ObjDir}DialogMgrExtensions.c.o"		Ä	"{CIncludes}Memory.h"						¶
...
"{ObjDir}ModalDialogMenuExtensions.a.o"	Ä	"{ObjDir}StandardEqu.d"						¶
...
"{ObjDir}ModalDialogMenuExtensions.c.o" Ä  "{CIncludes}Memory.h"						¶
											"{CIncludes}OSUtils.h"						¶
...
"{ObjDir}DialogDispatch.a.o"	Ä 	"{ObjDir}StandardEqu.d"							¶
