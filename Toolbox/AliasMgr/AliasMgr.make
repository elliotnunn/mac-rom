...
"{ObjDir}alExt.c.o"				Ä 	"{CIncludes}Aliases.h" 							¶
									"{CIncludes}Memory.h" 							¶
									"{CIncludes}Files.h" 							¶
									"{CIncludes}errors.h" 							¶
									"{CIncludes}String.h" 							¶
...
"{ObjDir}alFill.c.o"			Ä	"{CIncludes}Aliases.h" 							¶
									"{CIncludes}Memory.h" 							¶
									"{CIncludes}files.h" 							¶
									"{CIncludes}errors.h" 							¶
									"{AliasMgrDir}aliasPriv.h" 						¶
...
"{ObjDir}alFind.c.o"			Ä	"{CIncludes}Aliases.h" 							¶
									"{CIncludes}Memory.h" 							¶
									"{CIncludes}files.h" 							¶
									"{CIncludes}errors.h" 							¶
									"{CIncludes}String.h" 							¶
...
"{ObjDir}alUtil.c.o"			Ä 	"{CIncludes}Aliases.h" 							¶
									"{CIncludes}Memory.h" 							¶
									"{CIncludes}errors.h" 							¶
									"{CIncludes}Dialogs.h" 							¶
									"{CIncludes}ToolUtils.h" 						¶
...
"{ObjDir}AliasMgr.a.o"			Ä 	"{ObjDir}StandardEqu.d"		 					¶
...
"{ObjDir}FolderMgr.a.o"			Ä 	"{AIncludes}SysEqu.a"							¶
