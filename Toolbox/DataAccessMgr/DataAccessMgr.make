...
"{ObjDir}DataAccessResultsHandlers.a.o" Ä	"{DataAccessDir}DataAccessResultsHandlers.a"	¶
											"{ObjDir}StandardEqu.d"							¶
											"{AIncludes}DatabaseAccess.a"
	Asm {StdAOpts} -o "{Targ}" "{DataAccessDir}DataAccessResultsHandlers.a"


"{ObjDir}DataAccessResultsHandlers.c.o" Ä	"{DataAccessDir}DataAccessResultsHandlers.c"	¶
											"{DataAccessDir}DatabaseAccessPriv.h"			¶
											"{CIncludes}DatabaseAccess.h"
	C {StdCOpts} -o "{Targ}" "{DataAccessDir}DataAccessResultsHandlers.c"


"{ObjDir}DataAccessCompletion.a.o"	Ä	"{DataAccessDir}DataAccessCompletion.a"		¶
										"{ObjDir}StandardEqu.d"						¶
										"{AIncludes}DatabaseAccess.a"
	Asm {StdAOpts} -o "{Targ}" "{DataAccessDir}DataAccessCompletion.a"


"{ObjDir}DataAccessPackEntry.a.o" 	Ä	"{DataAccessDir}DataAccessPackEntry.a"		¶
									"{ObjDir}StandardEqu.d"							¶
									"{AIncludes}DatabaseAccess.a"					¶
