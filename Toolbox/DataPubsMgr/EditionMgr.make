...
"{LibDir}EditionMgr.lib"		Ä	"{ObjDir}dpPackEntry.a.o"
	Lib	{StdLibOpts} -o "{Targ}" "{ObjDir}dpPackEntry.a.o"


"{RsrcDir}EditionMgr.rsrc"		ÄÄ	"{EditionMgrDir}dpResources.r" 					¶
...
"{ObjDir}dpEvents.p.o"			Ä	"{EditionMgrDir}dpEvents.inc.p"					¶
...
"{ObjDir}dpInit.p.o"			Ä	"{EditionMgrDir}dpInit.inc.p"					¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{PInterfaces}Aliases.p"						¶
...
"{ObjDir}dpMisc.a.o"			Ä	"{ObjDir}StandardEqu.d"							¶
									"{IntAIncludes}EditionsPrivate.a"				¶
									"{EditionMgrDir}dpCompileOptions.inc.a"			¶
...
"{ObjDir}dpMisc.p.o"			Ä	"{EditionMgrDir}dpMisc.inc.p"					¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{IntPInterfaces}EditionsPrivate.p"				¶
...
"{ObjDir}dpPubControlBlock.p.o"	Ä	"{EditionMgrDir}dpPubControlBlock.inc.p"		¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{IntPInterfaces}EditionsPrivate.p" 	 		¶
...
"{ObjDir}dpPubIO.p.o"			Ä	"{EditionMgrDir}dpPubIO.inc.p"					¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{PInterfaces}Aliases.p"						¶
...
"{ObjDir}dpSection.p.o"			Ä	"{EditionMgrDir}dpSection.inc.p"				¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{PInterfaces}Aliases.p" 						¶
...
"{ObjDir}dpSectionIO.p.o"		Ä	"{EditionMgrDir}dpSectionIO.inc.p"				¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
									"{IntPInterfaces}EditionsPrivate.p" 			¶
...
"{ObjDir}dpDialogs.p.o"			Ä	"{EditionMgrDir}dpDialogs.inc.p"				¶
									"{EditionMgrDir}dpCompileOptions.inc.p"			¶
									"{IntPInterfaces}StandardEqu.p"					¶
									"{PInterfaces}Editions.p"						¶
