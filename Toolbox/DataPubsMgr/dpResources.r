...
// ÒRemove SectionÓ dialog: keep bounds within main dialog to allow updates
...
// ÒOpen Publisher ErrorÓ dialog: keep bounds within main dialog to allow updates
...
// ÒReconnect ErrorÓ dialog: keep bounds within main dialog to allow updates
