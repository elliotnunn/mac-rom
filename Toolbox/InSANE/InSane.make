...
"{ObjDir}ElemsHW.a.o"				Ä	"{InSaneDir}HWElemsEqus.a"					¶
...
"{RsrcDir}FPHW.rsrc"				Ä	"{InSaneDir}FPHW.a"							¶
...
"{ObjDir}FPHW.a.o"					Ä	"{InSaneDir}FPHW.a"
	Asm {StdAOpts} -d BackPatch=1 -o "{Targ}" "{InSaneDir}FPHW.a"
	
"{ObjDir}ELEMS020.a.o"			Ä	"{ObjDir}StandardEqu.d"							¶
									"{AIncludes}SANEMACS.a"							¶
...
"{ObjDir}FP020.a.o"				Ä	"{ObjDir}StandardEqu.d"							¶
									"{InSaneDir}FPEQUS.a"							¶
									"{AIncludes}SANEMACS.a"							¶
									"{InSaneDir}FPCTRL.a"							¶
									"{InSaneDir}FPOPS.a"							¶
