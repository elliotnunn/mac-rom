...
"{RsrcDir}CommToolbox.rsrc"		ÄÄ	"{CommNBPDir}StandardNBP.r"				¶
									"{RIncludes}Types.r"						¶
									"{RIncludes}CTBTypes.r"						¶
									"{RIncludes}PICT.r"							¶
									"{IntRIncludes}CommToolboxPriv.r"
...
"{ObjDir}CommToolboxUtilityRoutines.c.o"	Ä	"{CIncludes}Menus.h"								¶
												"{CIncludes}Dialogs.h"								¶
...
"{ObjDir}CommResourceMgr.p.o"				Ä	"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}Types.p"								¶
...
"{ObjDir}CommResourceMgrUtilities.a.o"		Ä	"{AIncludes}SysEqu.a"								¶
...
"{ObjDir}CommToolboxCore.c.o"				Ä	"{IntCIncludes}CommToolboxPriv.h"					¶
												"{CIncludes}CommResources.h"						¶
												"{CIncludes}CTBUtilities.h"							¶
...
"{ObjDir}ChooseUtilities.a.o"				Ä "{CommChooseDir}ChooseUtilities.a"
	Asm {StdAOpts} -o "{targ}" "{CommChooseDir}ChooseUtilities.a"


"{ObjDir}Choose.a.o"						Ä	"{IntAIncludes}CommToolboxPriv.a"					¶
												"{CommChooseDir}Choose.a"
	Asm {StdAOpts} -o "{targ}" "{CommChooseDir}Choose.a"


"{ObjDir}Choose.p.o"						Ä	"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
												"{PInterfaces}OSIntf.p"								¶
												"{PInterfaces}ToolIntf.p"							¶
												"{PInterfaces}PackIntf.p"							¶
...
"{ObjDir}StandardNBP.a.o"					Ä	"{CommNBPDir}StandardNBP.a"						¶
												"{IntAIncludes}CommToolboxPriv.a"
	Asm {StdAOpts} -o "{targ}" "{CommNBPDir}StandardNBP.a"


"{ObjDir}StandardNBP.p.o"					Ä	"{CommNBPDir}StandardNBP.p"						¶
...
"{ObjDir}ListUtilities.p.o"					Ä	"{CommNBPDir}ListUtilities.p"						¶
												"{CommNBPDir}StandardNBPStructures.p"				¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
												"{PInterfaces}OSIntf.p"								¶
...
"{ObjDir}ZIPUtilities.p.o"					Ä	"{CommNBPDir}ZIPUtilities.p"						¶
												"{CommNBPDir}StandardNBPStructures.p"				¶
												"{CommNBPDir}ListUtilities.p"						¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
...
"{ObjDir}NBPUtilities.p.o"					Ä	"{CommNBPDir}NBPUtilities.p"						¶
												"{CommNBPDir}StandardNBPStructures.p"				¶
												"{CommNBPDir}ListUtilities.p"						¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
...
"{ObjDir}StandardNBPUtilities.a.o"			Ä "{CommNBPDir}StandardNBPUtilities.a"
	Asm {StdAOpts} -o "{targ}" "{CommNBPDir}StandardNBPUtilities.a"


"{ObjDir}StandardNBPLDEF.a.o"				Ä	"{CommNBPDir}StandardNBPLDEF.a"					¶
												"{IntAIncludes}CommToolboxPriv.a"
	Asm {StdAOpts} -o "{Targ}" "{CommNBPDir}StandardNBPLDEF.a"


"{ObjDir}StandardNBPLDEF.p.o"				Ä	"{CommNBPDir}StandardNBPLDEF.p" 					¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
												"{PInterfaces}OSIntf.p"								¶
												"{PInterfaces}ToolIntf.p"							¶
...
"{ObjDir}CommToolboxLDEF.a.o"				Ä	"{CommUtilityDir}CommToolboxLDEF.a"			¶
												"{IntAIncludes}CommToolboxPriv.a"
	Asm {StdAOpts} -o "{targ}" "{CommUtilityDir}CommToolboxLDEF.a"


"{ObjDir}CommToolboxLDEF.p.o"				Ä	"{CommUtilityDir}CommToolboxLDEF.p" 			¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
												"{PInterfaces}OSIntf.p"								¶
												"{PInterfaces}ToolIntf.p"							¶
...
"{ObjDir}DITL.a.o"							Ä	"{CommUtilityDir}DITL.a"						¶
												"{IntAIncludes}CommToolboxPriv.a"
	Asm {StdAOpts} -o "{targ}" "{CommUtilityDir}DITL.a"


"{ObjDir}DITL.p.o"							Ä	"{CommUtilityDir}DITL.p" 						¶
												"{PInterfaces}MemTypes.p"							¶
												"{PInterfaces}QuickDraw.p"							¶
												"{PInterfaces}OSIntf.p"								¶
												"{PInterfaces}ToolIntf.p"							¶
...
"{ObjDir}ConnectionMgr.a.o"					Ä	"{CommConnectionDir}ConnectionMgr.a"					¶
...
"{ObjDir}ConnectionMgr.c.o"					Ä	"{CommConnectionDir}ConnectionMgr.c"					¶
												"{CIncludes}Errors.h"								¶
												"{CIncludes}Memory.h"								¶
												"{CIncludes}Resources.h"							¶
												"{CIncludes}OSUtils.h"								¶
...
"{ObjDir}TerminalMgr.a.o"					Ä	"{CommTerminalDir}TerminalMgr.a"						¶
...
"{ObjDir}TerminalMgr.c.o"					Ä	"{CommTerminalDir}TerminalMgr.c"					¶
												"{CIncludes}Memory.h"								¶
												"{CIncludes}Resources.h"							¶
...
"{ObjDir}FileTransferMgr.a.o"				Ä	"{CommFileTransferDir}FileTransferMgr.a"				¶
...
"{ObjDir}FileTransferMgr.c.o"				Ä	"{CommFileTransferDir}FileTransferMgr.c"				¶
												"{CIncludes}Memory.h"								¶
												"{CIncludes}Resources.h"							¶
												"{CIncludes}Types.h"								¶
												"{CIncludes}SysEqu.h"								¶
...
"{ObjDir}CommToolboxDispatcher.a.o"			Ä	"{CommStartupDir}CommToolboxDispatcher.a"			¶
												"{AIncludes}Traps.a"								¶
												"{AIncludes}ToolUtils.a"							¶
												"{AIncludes}SysEqu.a"								¶
												"{IntAIncludes}SysPrivateEqu.a"						¶
...
"{ObjDir}CRMBuiltInSerial.c.o"				Ä	"{CommStartupDir}CRMBuiltInSerial.c"				¶
												"{CIncludes}Memory.h"								¶
												"{CIncludes}Resources.h"							¶
												"{CIncludes}ToolUtils.h"							¶
												"{CIncludes}OSUtils.h"								¶
...
"{ObjDir}CommToolboxPatches.c.o"			Ä	"{CommStartupDir}CommToolboxPatches.c"				¶
												"{IntCIncludes}CommToolboxPriv.h"					¶
												"{CommResourceDir}CommResourceMgr.h"
	C {StdCOpts} -o "{Targ}" "{CommStartupDir}CommToolboxPatches.c" -i "{CommResourceDir}" 


"{ObjDir}CommToolboxPatches.a.o"			Ä "{CommStartupDir}CommToolboxPatches.a"
