...
"{ObjDir}BalloonPACK.p.o"		Ä	"{HelpMgrDir}BalloonPACK.p"						¶
...
"{ObjDir}BalloonWDEF.a.o"		Ä 	"{IntAIncludes}BalloonsPriv.a"					¶
									"{HelpMgrDir}BalloonWDEF.a"
	Asm {StdAOpts} -o "{targ}" "{HelpMgrDir}BalloonWDEF.a"


"{ObjDir}BalloonWDEF.p.o"		Ä "{HelpMgrDir}BalloonWDEF.p"
	Pascal {StdPOpts} -o "{targ}" "{HelpMgrDir}BalloonWDEF.p"


"{ObjDir}BalloonExtensions.a.o"	Ä 	"{ObjDir}StandardEqu.d"							¶
...
"{ObjDir}Balloonptch28.p.o"		Ä 	"{PInterfaces}Balloons.p"						¶
									"{HelpMgrDir}BalloonDefs.p"						¶
