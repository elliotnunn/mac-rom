...
"{LibDir}TextServicesMgr.lib" 	Ä	{TextServicesMgrObjs}
	Lib {StdLibOpts} -o "{Targ}"	{TextServicesMgrObjs}


"{ObjDir}TSMExtension.a.o"	Ä	"{ObjDir}StandardEqu.d"							¶
...
{ObjDir}TSMFunctions.c.o	Ä	"{TextServicesDir}TSMFunctions.c"				¶
...
"{ObjDir}TSMUtility.c.o"	Ä	"{TextServicesDir}TSMUtility.c"					¶
								"{CIncludes}Script.h"							¶
								"{CIncludes}Components.h"						¶
								"{IntCIncludes}TSMPrivate.h"					¶
								"{CIncludes}TextServices.h"
...
"{ObjDir}TSMInternalUtils.c.o"	Ä	"{TextServicesDir}TSMInternalUtils.c"		¶
									"{CIncludes}Components.h"					¶
									"{IntCIncludes}TSMPrivate.h"				¶
									"{CIncludes}TextServices.h"
