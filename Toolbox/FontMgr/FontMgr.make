...
"{ObjDir}BassExtensions.a.o" 		Ä 	"{IntAIncludes}LinkedPatchMacros.a"			¶
...
"{ObjDir}Bass_Allocate.a.o" 		Ä 	"{FontMgrDir}SplineDefines.a"				¶
										"{IntAIncludes}fontPrivate.a"				¶
...
"{ObjDir}Bass_Cache.c.o"			Ä 	"{CIncludes}Types.h"						¶
										"{CIncludes}Memory.h"						¶
...
"{ObjDir}DoubleByteBassCache.c.o"	Ä 	"{CIncludes}Fonts.h"						¶
										"{CIncludes}Memory.h"						¶
										"{CIncludes}Script.h"						¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}FontScaler.h"					¶
...
"{ObjDir}DoubleByteSupport.a.o"		Ä	"{AIncludes}Script.a"						¶
										"{AIncludes}SysEqu.a"						¶
										"{AIncludes}ToolUtils.a"					¶
...
"{ObjDir}FontMgr.a.o" 				Ä	"{FontMgrDir}SplineDefines.a" 				¶
										"{IntAIncludes}fontPrivate.a"				¶
										"{AIncludes}QuickDraw.a"					¶
										"{IntAIncludes}ColorEqu.a"					¶
										"{ColorQDDir}qdHooks.a"						¶
...
"{ObjDir}FontScaler.c.o"			Ä	"{FontMgrDir}FontScaler.h" 					¶
...
"{ObjDir}fnt.c.o" 					Ä	"{FontMgrDir}fnt.h"							¶
										"{Cincludes}FixMath.h"						¶
										"{FontMgrDir}FontMath.h"					¶
										"{Cincludes}setjmp.h"						¶
										"{FontMgrDir}FSCdefs.h"						¶
...
"{ObjDir}FSglue.c.o" 				Ä 	"{FontMgrDir}sc.h"							¶
										"{FontMgrDir}privateSFNT.h"					¶
										"{CIncludes}ToolUtils.h"					¶
										"{Cincludes}FixMath.h"						¶
										"{FontMgrDir}FontMath.h"					¶
...
"{ObjDir}embeddedBitmap.c.o" 		Ä 	"{FontMgrDir}sc.h"							¶
										"{FontMgrDir}FontMath.h"					¶
										"{FontMgrDir}fnt.h"							¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}sfnt.h"						¶
...
"{ObjDir}MacExtra.c.o" 				Ä 	"{FontMgrDir}FontScaler.h" 					¶
										"{FontMgrDir}privateSFNT.h"					¶
										"{FontMgrDir}MacExtra.h"					¶
...
"{ObjDir}MapString.c.o" 			Ä 	"{FontMgrDir}MapString.h" 					¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}MapString.c"
	C {StdCOpts} -o "{Targ}" "{FontMgrDir}MapString.c" 


"{ObjDir}OutlineMetrics.a.o"		 Ä 	"{AIncludes}SysEqu.a"						¶
										"{IntAIncludes}SysPrivateEqu.a"				¶
										"{AIncludes}Traps.a"						¶
										"{AIncludes}QuickDraw.a"					¶
										"{AIncludes}ToolUtils.a"					¶
...
"{ObjDir}sc.c.o" 					Ä 	"{FontMgrDir}sc.h"							¶
										"{FontMgrDir}FSError.h"						¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}sc.c"
...
"{ObjDir}sfnt.c.o" 					Ä	"{FontMgrDir}sfnt.h"						¶
										"{FontMgrDir}privateSFNT.h"					¶
										"{Cincludes}FixMath.h"						¶
										"{FontMgrDir}FontMath.h"					¶
...
"{ObjDir}FontMath.c.o" 				Ä	"{FontMgrDir}FontMath.h"					¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}FontMath.c"
	C {StdCOpts} -o "{Targ}" "{FontMgrDir}FontMath.c" 


"{ObjDir}FontMath.a.o" 				Ä 	"{FontMgrDir}FontMath.a"
	Asm {StdAOpts} -o "{Targ}" {FntIncOpts} "{FontMgrDir}FontMath.a"


"{ObjDir}Assertion.c.o"				Ä	"{FontLibDir}Source:Assertion.c"
	C {StdCOpts} -o "{Targ}" {FntIncOpts} "{FontLibDir}Source:Assertion.c"


"{ObjDir}ZoneHandle.c.o"			Ä	"{FontLibDir}Source:ZoneHandle.c"
	C {StdCOpts} -o "{Targ}" {FntIncOpts} "{FontLibDir}Source:ZoneHandle.c"


"{ObjDir}StringUtility.c.o"			Ä	"{FontLibDir}Source:StringUtility.c"
	C {StdCOpts} -o "{Targ}" {FntIncOpts} "{FontLibDir}Source:StringUtility.c"


"{ObjDir}Fragment.c.o" 				Ä 	"{PartialDir}Source:Fragment.c"				¶
										"{CIncludes}Memory.h"						¶
										"{CIncludes}Resources.h"					¶
...
"{ObjDir}FragmentTable.c.o" 		Ä 	"{PartialDir}Source:FragmentTable.c"		¶
										"{CIncludes}Memory.h"						¶
										"{CIncludes}Types.h"						¶
										"{FontLibIfDir}Assertion.h"					¶
										"{FontLibIfDir}BaseIncludes.h"				¶
...
"{ObjDir}PartialFontExtensions.c.o"	Ä 	"{PartialDir}Source:PartialFontExtensions.c" ¶
										"{CIncludes}Memory.h"						¶
										"{FontMgrDir}FSCdefs.h"						¶
										"{FontMgrDir}MapString.h"					¶
										"{FontMgrDir}sfnt.h"						¶
