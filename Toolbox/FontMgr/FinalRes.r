...
data 'CHAZ' (0) {
	...
	$"20 54 72 75 65 54 79 70 65 AA 20 69 6E 69 74 2E"    /*  TrueTypeª init. */
	$"00"                                                 /* . */
};
...
resource 'DITL' (0) {
	{	/* array DITLarray: 2 elements */
		...
		StaticText {
			disabled,
			"Mouse button downÉ skipping TrueTypeª installation."
		}
	}
};
...
resource 'DITL' (1) {
	{	/* array DITLarray: 2 elements */
		...
		StaticText {
			disabled,
			"Cannot install TrueTypeªÉ system 6.0.5 or greater is required."
		}
	}
};
...
resource 'DITL' (2) {
	{	/* array DITLarray: 2 elements */
		...
		StaticText {
			disabled,
			"System Error:  aborting TrueTypeª installation!"
		}
	}
};
...
resource 'DITL' (3) {
	{	/* array DITLarray: 2 elements */
		...
		StaticText {
			disabled,
			"TrueTypeª is already installedÉ  skipping installation!!!"
		}
	}
};
